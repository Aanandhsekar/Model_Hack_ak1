...
| Java | Programming Language | | Selenium WebDriver | Browser Automation | | TestNG | Test Framework | | Maven | Build Management | | WebDriverManager | Driver Management | | ExtentReports | HTML Reporting | | Git & GitHub | Version Control |
